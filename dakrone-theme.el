...
(custom-theme-set-faces
 ...
 '(foreground-color ((t (:foreground "cornsilk"))))
 ...
 '(magit-diff-add ((t (:foreground "green3" :background "gray10"))))
 '(magit-diff-del ((t (:foreground "red3" :background "gray10"))))
 '(magit-diff-file-header ((t (:background "gray10"))))
 '(magit-diff-hunk-header ((t (:background "gray10"))))
 '(diff-added ((t (:foreground "green4" :background "gray10"))))
 '(diff-removed ((t (:foreground "red3" :background "gray10"))))
